...
public class CalcuTest {
	...
	public void setUp(){
        ...
        /**
         * to test zero method to find the root of x^2-2
         * using 1 as an initial approximation and 0.01 as an tolerance
         */
        @Test
         ...
         * who use the operator classes's toString and methods
         * so it can also test operator classes 
         */
        @Test
